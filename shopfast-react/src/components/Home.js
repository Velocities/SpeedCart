...
function Home() {
  return (
    <div className={styles.topElement}>
      ...
      <p>
        ShopFast is a software application that gives plausible routes for your list of groceries
        so you can save time. In order to stay up to date with changes in these routes, ShopFast
      ...
      <p>
        ...
        ShopFast accounts for this by leaving such items at the end of your route for lower risk
